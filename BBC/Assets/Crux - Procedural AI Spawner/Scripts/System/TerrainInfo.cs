...
namespace Crux.Utility
{
    public class TerrainInfo : MonoBehaviour
    {
        ...
        public void UpdateTerrainInfo()
        {
            ...
            {
                if (Physics.Raycast(new Vector3(transform.position.x, transform.position.y + 100, transform.position.z), -Vector3.up, out hit, 200, CruxSystem.Instance.TerrainInfoLayerMask))
                {
