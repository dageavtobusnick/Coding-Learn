...
public class ExchangeButtonLevel5Behaviour : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        themePart1Button = GameObject.Find("Theme5_Part1Button").GetComponent<Button>();
        ...
        themePart2Button = GameObject.Find("Theme5_Part2Button").GetComponent<Button>();
        ...
        themePart3Button = GameObject.Find("Theme5_Part3Button").GetComponent<Button>();
        ...
        themePart4Button = GameObject.Find("Theme5_Part4Button").GetComponent<Button>();
        ...
        themePart5Button = GameObject.Find("Theme5_Part5Button").GetComponent<Button>();
