...
Мне задали задание по математике, есть способ составить программку для решения подобных задач?
...
Пример вывода: 8";
    ...
    public void ShowTask2()
    {
        taskNumber = 2;
        taskDescription = @"                                                               Задание
И мне мудрец тоже задал такое задание(
...
Например, если введено число 325, то сумма его цифр равна 10 (3+2+5), а произведение 30 (3*2*5).";
    ...
    public void ShowTask3()
    {
        taskNumber = 3;
        taskDescription = @"                                                               Задание
А вот мы задались следующим вопросом
Используя циклы, вывести сначала нечётные числа до 20, а затем их квадраты.";
    ...
    public void ShowTask4()
    {
        taskNumber = 4;
        taskDescription = @"                                                               Задание
Напишите программу, которая выводит на консоль таблицу умножения, чтобы работы первоклассников стало проверять проще";
        ShowTask();
    }
